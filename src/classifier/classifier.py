...
# Create tags for penne and spaghetti
gnocchi_tag = trainer.create_tag(project.id, "gnocchi")
rissotto_tag = trainer.create_tag(project.id, "rissotto")

# Upload and tag images
images_folder = os.path.join(os.path.dirname(__file__), "images", "Train")
tags_folder_names = [ "gnocchi", "rissotto" ]
